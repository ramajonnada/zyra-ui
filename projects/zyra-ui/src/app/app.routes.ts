...
export const routes: Routes = [
	...
	},
	{
		...
		data: {
			seo: {
				title: 'Angular Docs – Zyra UI',
				description: 'Learn Angular step by step with Zyra UI docs.'
			}
		},
	},
	{
	...
	},
	{
		...
		loadComponent: () =>
			import('./components/privacy-policy/privacy-policy').then(() => PrivacyPolicy),
	},
	{
		path: 'termsofservices',
		loadComponent: () =>
			import('./components/terms-of-services/terms-of-services').then(() => TermsOfServices),
	},
];
