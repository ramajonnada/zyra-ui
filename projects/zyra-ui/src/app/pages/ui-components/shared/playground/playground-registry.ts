...
export const PLAYGROUND_REGISTRY: Record<string, PlaygroundConfig> = {
    ...
    button: {
        ...
        controls: [
            { type: 'button-group', key: 'variant', label: 'variant', options: ['primary', 'secondary', 'ghost', 'outline', 'danger'], defaultValue: 'primary' },
            { type: 'button-group', key: 'size', label: 'size', options: ['sm', 'md', 'lg'], defaultValue: 'md' },
            { type: 'toggle', key: 'loading', label: 'states', toggleLabel: 'loading', defaultValue: false },
            { type: 'toggle', key: 'disabled', label: '', toggleLabel: 'disabled', defaultValue: false },
            { type: 'toggle', key: 'fullWidth', label: '', toggleLabel: 'fullWidth', defaultValue: false },
            { type: 'text', key: 'label', label: 'label', placeholder: 'Button textâ€¦', defaultValue: 'Button' },
        ],
        codeTemplate: (s) => {
            const a: string[] = [];
    ...
    badge: {
        ...
        controls: [
            { type: 'button-group', key: 'variant', label: 'variant', options: ['success', 'warning', 'danger', 'info', 'purple', 'default'], defaultValue: 'success' },
            { type: 'button-group', key: 'size', label: 'size', options: ['sm', 'md', 'lg'], defaultValue: 'md' },
            { type: 'toggle', key: 'dot', label: 'states', toggleLabel: 'dot', defaultValue: false },
            { type: 'text', key: 'label', label: 'label', placeholder: 'Badge textâ€¦', defaultValue: 'Badge' },
        ],
        codeTemplate: (s) => {
            const a: string[] = [];
    ...
    card: {
        ...
        controls: [
            { type: 'button-group', key: 'variant', label: 'variant', options: ['default', 'outlined', 'elevated', 'ghost'], defaultValue: 'default' },
            { type: 'button-group', key: 'padding', label: 'padding', options: ['none', 'sm', 'md', 'lg'], defaultValue: 'md' },
            { type: 'toggle', key: 'clickable', label: 'states', toggleLabel: 'clickable', defaultValue: false },
            { type: 'toggle', key: 'hasHeader', label: '', toggleLabel: 'hasHeader', defaultValue: false },
            { type: 'toggle', key: 'hasFooter', label: '', toggleLabel: 'hasFooter', defaultValue: false },
        ],
        codeTemplate: (s) => {
            const a: string[] = [];
            if (s['variant'] !== 'default') a.push(`  variant="${s['variant']}"`);
    ...
    avatar: {
        ...
        controls: [
            { type: 'button-group', key: 'size', label: 'size', options: ['xs', 'sm', 'md', 'lg', 'xl'], defaultValue: 'md' },
            { type: 'button-group', key: 'variant', label: 'variant', options: ['teal', 'blue', 'purple', 'warm', 'neutral'], defaultValue: 'teal' },
            { type: 'toggle', key: 'square', label: 'shape', toggleLabel: 'square', defaultValue: false },
            { type: 'text', key: 'name', label: 'name', placeholder: 'Full nameâ€¦', defaultValue: 'Dev Zyra' },
        ],
        codeTemplate: (s) => {
    ...
    input: {
        ...
        stageClass: 'column',
        controls: [
            { type: 'button-group', key: 'type', label: 'type', options: ['text', 'email', 'password', 'number', 'search'], defaultValue: 'text' },
            { type: 'button-group', key: 'appearance', label: 'appearance', options: ['outline', 'filled', 'underline'], defaultValue: 'outline' },
            { type: 'button-group', key: 'size', label: 'size', options: ['sm', 'md', 'lg'], defaultValue: 'md' },
            { type: 'text', key: 'hint', label: 'hint', placeholder: 'Hint textâ€¦', defaultValue: 'This is a hint' },
            { type: 'toggle', key: 'clearButton', label: 'features', toggleLabel: 'clearButton', defaultValue: false },
            { type: 'toggle', key: 'loading', label: '', toggleLabel: 'loading', defaultValue: false },
        ],
        codeTemplate: (s) => {
            const ff: string[] = [];
            ...
            const ffOpen = ff.length ? `<zyra-form-field label="Label"\n${ff.join('\n')}\n>` : `<zyra-form-field label="Label">`;
            const inpTag = inp.length ? `  <zyra-input\n${inp.join('\n')}\n  />` : `  <zyra-input />`;
            return `${ffOpen}\n${inpTag}\n</zyra-form-field>`;
        },
    },
    ...
    chip: {
        ...
        controls: [
            { type: 'button-group', key: 'variant', label: 'variant', options: ['default', 'success', 'warning', 'danger', 'info', 'purple'], defaultValue: 'default' },
            { type: 'button-group', key: 'size', label: 'size', options: ['sm', 'md', 'lg'], defaultValue: 'md' },
            { type: 'text', key: 'label', label: 'label', placeholder: 'Chip labelâ€¦', defaultValue: 'Frontend' },
            { type: 'toggle', key: 'dismissible', label: 'states', toggleLabel: 'dismissible', defaultValue: false },
            { type: 'toggle', key: 'disabled', label: '', toggleLabel: 'disabled', defaultValue: false },
        ],
        codeTemplate: (s) => {
            const a: string[] = [];
    ...
    alert: {
        ...
        stageClass: 'column',
        controls: [
            { type: 'button-group', key: 'variant', label: 'variant', options: ['info', 'success', 'warning', 'danger'], defaultValue: 'info' },
            { type: 'text', key: 'title', label: 'title', placeholder: 'Alert titleâ€¦', defaultValue: 'Heads up' },
            { type: 'toggle', key: 'dismissible', label: 'states', toggleLabel: 'dismissible', defaultValue: false },
        ],
        codeTemplate: (s) => {
            const a: string[] = [];
    ...
    progress: {
        ...
        stageClass: 'column',
        controls: [
            { type: 'button-group', key: 'variant', label: 'variant', options: ['default', 'success', 'warning', 'danger', 'info'], defaultValue: 'default' },
            { type: 'button-group', key: 'size', label: 'size', options: ['sm', 'md', 'lg'], defaultValue: 'md' },
            { type: 'button-group', key: 'value', label: 'value', options: ['25', '50', '65', '75', '100'], defaultValue: '65' },
            { type: 'toggle', key: 'showLabel', label: 'states', toggleLabel: 'showLabel', defaultValue: true },
            { type: 'toggle', key: 'indeterminate', label: '', toggleLabel: 'indeterminate', defaultValue: false },
        ],
        codeTemplate: (s) => {
            const a: string[] = [];
            if (s['variant'] !== 'default') a.push(`  variant="${s['variant']}"`);
    ...
    divider: {
        ...
        stageClass: 'column',
        controls: [
            { type: 'button-group', key: 'orientation', label: 'orientation', options: ['horizontal', 'vertical'], defaultValue: 'horizontal' },
            { type: 'button-group', key: 'variant', label: 'variant', options: ['solid', 'dashed', 'dotted'], defaultValue: 'solid' },
            { type: 'button-group', key: 'align', label: 'align', options: ['start', 'center', 'end'], defaultValue: 'center' },
            { type: 'text', key: 'label', label: 'label', placeholder: 'Divider labelâ€¦', defaultValue: 'or' },
        ],
        codeTemplate: (s) => {
            const a: string[] = [];
    ...
    accordion: {
        ...
        stageClass: 'column',
        controls: [
            { type: 'toggle', key: 'allowMultiple', label: 'behaviour', toggleLabel: 'allowMultiple', defaultValue: false },
        ],
        codeTemplate: (s) => {
            const a: string[] = [];
    ...
    checkbox: {
        ...
        controls: [
            { type: 'button-group', key: 'size', label: 'size', options: ['sm', 'md', 'lg'], defaultValue: 'md' },
            { type: 'button-group', key: 'labelPosition', label: 'label position', options: ['left', 'right'], defaultValue: 'right' },
            { type: 'text', key: 'label', label: 'label', placeholder: 'Label textâ€¦', defaultValue: 'Accept terms and conditions' },
    ...
    radio: {
        ...
        controls: [
            { type: 'button-group', key: 'orientation', label: 'orientation', options: ['vertical', 'horizontal'], defaultValue: 'vertical' },
            { type: 'toggle', key: 'disabled', label: 'states', toggleLabel: 'disabled', defaultValue: false },
        ],
        codeTemplate: (s) => {
    ...
    skeleton: {
        ...
        controls: [
            {
                type: 'button-group', key: 'variant', label: 'Type',
                options: ['text','circle','rect','rounded','avatar','image','button','input','card','list','article','table','chat','dashboard','video','chart','product','profile','calendar'],
                defaultValue: 'card',
            },
            { type: 'button-group', key: 'lines', label: 'lines', options: ['1','2','3','5'], defaultValue: '3' },
            { type: 'button-group', key: 'rows',  label: 'rows',  options: ['3','5','7'],    defaultValue: '5' },
            { type: 'toggle', key: 'animated', label: 'states', toggleLabel: 'animated', defaultValue: true },
        ],
        codeTemplate: (s) => {
            const a: string[] = [];
            ...
            if (['list','table'].includes(s['variant'] as string)) a.push(`  [rows]="${s['rows']}"`);
    ...
    tabs: {
        ...
        stageClass: 'column',
        controls: [
            { type: 'button-group', key: 'variant',     label: 'variant',      options: ['underline', 'pill', 'filled', 'outlined'], defaultValue: 'underline' },
            { type: 'button-group', key: 'size',        label: 'size',         options: ['sm', 'md', 'lg'],                          defaultValue: 'md' },
            { type: 'button-group', key: 'orientation', label: 'orientation',  options: ['horizontal', 'vertical'],                  defaultValue: 'horizontal' },
            { type: 'toggle',       key: 'icon',        label: 'icon',         toggleLabel: 'show icons',                            defaultValue: false },
            { type: 'toggle',       key: 'badge',       label: 'badge',        toggleLabel: 'show badges',                           defaultValue: false },
            { type: 'toggle',       key: 'closeable',   label: 'closeable',    toggleLabel: 'enable closeable',                      defaultValue: false },
            { type: 'toggle',       key: 'disabled',    label: 'states',       toggleLabel: 'disabled tab',                          defaultValue: false },
        ],
        codeTemplate: (s) => {
            const a: string[] = [];
    ...
    textarea: {
        ...
        controls: [
            { type: 'button-group', key: 'size', label: 'size', options: ['sm', 'md', 'lg'], defaultValue: 'md' },
            { type: 'button-group', key: 'resize', label: 'resize', options: ['none', 'vertical', 'auto'], defaultValue: 'vertical' },
        ],
        codeTemplate: (s) => {
            const a: string[] = [];
            if (s['size'] !== 'md')       a.push(`  size="${s['size']}"`);
            if (s['resize'] !== 'vertical') a.push(`  resize="${s['resize']}"`);
            const inner = a.length ? `  <zyra-textarea\n${a.join('\n')}\n  />` : `  <zyra-textarea />`;
    ...
    modal: {
        ...
        controls: [
            { type: 'button-group', key: 'size', label: 'size', options: ['sm', 'md', 'lg', 'xl'], defaultValue: 'md' },
            { type: 'text', key: 'title', label: 'title', placeholder: 'Modal titleâ€¦', defaultValue: 'Confirm action' },
            { type: 'toggle', key: 'dismissible', label: 'behaviour', toggleLabel: 'dismissible', defaultValue: true },
        ],
        codeTemplate: (s) => {
    ...
    toggle: {
        ...
        controls: [
            { type: 'button-group', key: 'size', label: 'size', options: ['sm', 'md', 'lg'], defaultValue: 'md' },
            { type: 'button-group', key: 'labelPosition', label: 'label position', options: ['left', 'right'], defaultValue: 'right' },
            { type: 'text', key: 'label', label: 'label', placeholder: 'Toggle labelâ€¦', defaultValue: 'Enable notifications' },
            { type: 'toggle', key: 'disabled', label: 'states', toggleLabel: 'disabled', defaultValue: false },
        ],
        codeTemplate: (s) => {
            const a: string[] = [];
    ...
    spinner: {
        ...
        controls: [
            { type: 'button-group', key: 'size', label: 'size', options: ['xs', 'sm', 'md', 'lg'], defaultValue: 'md' },
            { type: 'button-group', key: 'color', label: 'color', options: ['accent', 'accent-2', 'white', 'current'], defaultValue: 'accent' },
            { type: 'text', key: 'label', label: 'label (aria)', placeholder: 'Loadingâ€¦', defaultValue: 'Loadingâ€¦' },
        ],
        codeTemplate: (s) => {
            const a: string[] = [];
            if (s['size'] !== 'md')      a.push(`  size="${s['size']}"`);
    ...
    toast: {
        ...
        controls: [
            { type: 'button-group', key: 'variant', label: 'variant', options: ['success', 'error', 'warning', 'info', 'default'], defaultValue: 'success' },
            { type: 'text', key: 'title', label: 'title', placeholder: 'Toast titleâ€¦', defaultValue: 'Operation completed' },
            { type: 'text', key: 'description', label: 'description', placeholder: 'Optional descriptionâ€¦', defaultValue: 'Your changes have been saved.' },
            { type: 'toggle', key: 'persistent', label: 'behaviour', toggleLabel: 'persistent (never auto-dismiss)', defaultValue: false },
        ],
        codeTemplate: (s) => {
    ...
    tooltip: {
        ...
        controls: [
            { type: 'button-group', key: 'position', label: 'position', options: ['top', 'bottom', 'left', 'right'], defaultValue: 'top' },
            { type: 'button-group', key: 'maxWidth', label: 'maxWidth', options: ['120px', '200px', '300px'], defaultValue: '200px' },
            { type: 'text', key: 'tooltipText', label: 'text', placeholder: 'Tooltip contentâ€¦', defaultValue: 'This is a tooltip!' },
        ],
        codeTemplate: (s) => {
    ...
    'form-field': {
        ...
        controls: [
            { type: 'button-group', key: 'appearance', label: 'appearance', options: ['outline', 'filled', 'underline'], defaultValue: 'outline' },
            { type: 'button-group', key: 'size', label: 'size', options: ['sm', 'md', 'lg'], defaultValue: 'md' },
            { type: 'text', key: 'label', label: 'label', placeholder: 'Field labelâ€¦', defaultValue: 'Label' },
            { type: 'text', key: 'hint', label: 'hint', placeholder: 'Helper textâ€¦', defaultValue: '' },
        ],
        codeTemplate: (s) => {
            const a: string[] = [];
            if (s['label'])                    a.push(`  label="${s['label']}"`);
