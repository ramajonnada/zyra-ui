...
:root {
  ...
  --zyra-font-body:            'Inter', sans-serif;
    ...
    readonly colorSwatches: readonly ColorSwatch[] = [
        ...
        { name: 'Purple', variable: '--zyra-color-purple-foreground' },
        { name: 'Purple subtle', variable: '--zyra-color-purple-subtle' },
        { name: 'Surface (code)', variable: '--zyra-color-surface-code' },
