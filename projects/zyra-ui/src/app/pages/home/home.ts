...
import { ZyraAvatar, ZyraBadge, ZyraButton, ZyraCard, ZyraToastService } from 'zyra-ng-ui';
...
const INSTALL_COMMAND = 'npx zyra-ng-ui@latest init';
...
const DEVELOPER_CHECKS = [
    'Framework-agnostic primitives with Angular-first ergonomics',
    'Standalone imports and typed APIs that stay honest',
    'CSS variables for effortless theming',
    'A11y-first states and polished motion defaults',
] as const;
...
const FEATURE_CARDS: readonly IconCard[] = [
    {
        title: 'Accessible',
        description:
            'WCAG-aware focus rings, keyboard states, and semantic markup ship with the primitives.',
    ...
    },
    {
        title: 'Themable',
        description:
            'The same token system powers the website chrome, product UI, and design primitives.',
        icon: appIcons.palette,
        tone: 'purple',
    },
    {
        ...
        description:
            'Built with Angular patterns first so imports, forms, and signals stay familiar.',
        icon: appIcons.codeBranch,
        tone: 'blue',
    },
    {
        title: 'Tree-shakeable',
        description: 'Import what you need and keep the shipped surface lean for production apps.',
    ...
    },
    {
        ...
        description:
            'Every token, border, and surface starts from a dark-first baseline with a clean light theme.',
        icon: appIcons.moon,
        tone: 'neutral',
    },
    {
        title: 'Smooth motion',
        description:
            'Fast, medium, and slow timings come from the shared token layer for consistent interaction feel.',
...
const TESTIMONIALS: readonly Testimonial[] = [
    {
        quote: 'ZyraUI is the first library that does not make my designer cry. We rebuilt our entire dashboard in two days.',
        author: 'Maya Chen',
        role: 'Staff engineer, SuperStatus',
    },
    {
        quote: 'The motion system alone is worth it. Every interaction feels considered. It is the Linear of UI libraries.',
        author: 'Dev Patel',
        role: 'Founding eng, Orbital',
        avatarVariant: 'blue',
    },
    {
        quote: 'Finally a dark theme I do not want to tear apart. The neon cyan is tasteful when the tokens do the work.',
        author: 'Ines Muller',
...
@Component({
    selector: 'app-home',
    imports: [RouterLink, FaIconComponent, ZyraAvatar, ZyraBadge, ZyraButton, ZyraCard],
